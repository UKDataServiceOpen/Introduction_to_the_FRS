...
1\.
There are `r nrow(frs_adult2122_short)` cases in the adult dataset and `r nrow(frs_benunit2122_short)` in the benunit dataset.

2\.
The total number of variables is `r ncol(frs_adult2122_short)` in the adult dataset and `r ncol(frs_benunit2122_short)` in the benunit dataset..
...
4\.
There are a total of `r ncol(merged_data)` variables in the new merged data.
